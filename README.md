...
- 帳號、權限申請、管理與稽核。
- 帳號 Email 綁定與忘記密碼驗證碼寄送（可選用 Gmail SMTP）。
...
- **Gmail 驗證服務**：可連線至 Gmail SMTP 的網路環境，以及已啟用兩步驟驗證的 Gmail 帳號與應用程式密碼

---

### 系統部署與架設教學
#### 本專案的完整架設步驟、Windows 多人正式環境、IIS + ARR 設定、自動開機、Debug／正式模式切換、資料庫連線與備份還原流程，皆已整理至專屬手冊： 👉 **[請參閱：架設步驟.md](架設步驟.md)**
---
