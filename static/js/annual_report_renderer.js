(function(global) {
  ...
  const ANALYSIS_CONDITIONS = Object.freeze([
    ...
    { label: '分期呈現最細碼', analysisId: 'chkStageDetailed', comparisonId: 'compareItemStageDetailed' },
    { label: '分期不呈現最細碼', analysisId: 'chkStageSummary', comparisonId: 'compareItemStageSummary' },
    { label: '初次療程分類', analysisId: 'chkTreatmentFirstCourse', comparisonId: 'compareItemTreatmentFirstCourse' },
    { label: '初次手術方式', analysisId: 'chkTreatmentSurgery', comparisonId: 'compareItemTreatmentSurgery' },
