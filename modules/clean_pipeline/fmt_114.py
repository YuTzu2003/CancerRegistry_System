RULES = {
    ...
    '其他分期系統期別(臨床分期)':{
        ...
        'max_length': 4,
        'choices': ['0', '1', '1A', '1A1', '1A2', '1B', '1B1', '1B2', '1C', '2', '2A', '2A1', '2A2', '2B', '2C', '3', '3A', '3B', '3C', '3C1', '3C2', '4', '4A', '4B', '8888', '9999', 'A', 'B', 'C', 'D', 'L', 'E', 'X'],
    ...
    '其他分期系統期別(病理分期)':{
        ...
        'max_length': 4,
        'pattern_range': '0, 1, 1A, 1A1, 1A2, 1B, 1B1, 1B2, 1C, 1C1, 1C2, 1C3, 2, 2A, 2A1, 2A2, 2B, 2C, 3, 3A, 3A1, 3A11, 3A12, 3A2, 3B, 3C, 3C1, 3C2, 4, 4A, 4B, 8888, A, B1, B2, B3, C1, C2, C3, D',
        'description': '依所選擇「其他分期系統」之分類標準予以編碼。',
        'purpose': '無。'
    },
    '其他分期系統期別(病理分期)判讀者 ':{
