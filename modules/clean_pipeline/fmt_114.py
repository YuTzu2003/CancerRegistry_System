RULES = {
    ...
    '其他分期系統期別(病理分期)判讀者 ':{
        'ID':'3.22',
        'field': 'Staged by (Other Pathologic Stage)',
        'length': 1,
        'digit': True,
        'range': [0, 9],
    ...
    '未放射治療原因':{
        'ID':'4.2.1.8',
        'field': 'Reasons for No RT',
        'length': 1,
        'digit': True,
        'choices': ['0', '1', '2', '5', '6', '7', '8', '9'],       
        'description': '記錄在申報醫院的首次療程中，沒有接受放射治療的理由。',
        'purpose': '有助於了解建議之治療模式未被採用的理由。'
    },
    '體外放射治療技術':{
        'ID':'4.2.2.1',
