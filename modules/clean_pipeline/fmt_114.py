RULES = {
    ...
    '放射治療臨床標靶體積摘要':{
        ...
        'note': (
            '4.2.1.1 放射治療臨床標靶體積摘要欄位採位元加總的組合編碼，可同時表示多處放射治療部位。\n'
    ...
    '放射治療機構':{
        ...
        'definition': (
            '0:未接受放射治療。\n'
            '1:僅於申報醫院接受放射治療。\n'
            '2:申報醫院治療後，於國內他院追加放射治療。\n'
            '3:國內他院治療後，於申報醫院追加放射治療。\n'
            '4:所有放射治療皆於國內他院完成。\n'
            '5:申報醫院治療後，於國外醫院追加放射治療。\n'
            '6:國外醫院治療後，於申報醫院追加放射治療。\n'
            '7:所有放射治療皆於國外醫院完成。\n'
            '8:有接受放射治療，但機構或方式無法分類。\n'
            '9:放射治療情形不詳。\n'
        ),
    },
    '未放射治療原因':{
        ...
        'definition': (
            '0:已於申報醫院接受首次療程放射治療。\n'
            '1:放射治療不屬於首次療程計畫，或採積極監測/觀察。\n'
            '2:因禁忌症、風險因素或疾病進展未建議放射治療。\n'
            '5:原規劃放射治療，但個案於治療前死亡或病危。\n'
            '6:原規劃放射治療未執行、原因未記載，或於他院執行。\n'
            '7:原規劃放射治療，但個案或家屬拒絕。\n'
            '8:原規劃放射治療，但摘錄時尚未執行。\n'
            '9:放射治療情形不詳。\n'
        ),
    ...
    '其他放射治療技術':{
        ...
        'note': '除 -9、-1、0 外，相同的 4.2.3.2 代碼會因 4.2.3.1 的值不同，而代表不同治療技術，解讀時不可只看本欄位。'
    },
    '其他放射治療臨床標靶體積':{
        'ID':'4.2.3.3.1',
    ...
    '骨髓/幹細胞移植或內分泌處置':{
        ...
        'definition': (
            ...
            '82:骨髓/幹細胞移植或內分泌處置因禁忌症、高風險或疾病進展未建議治療。\n'
    ...
    '申報醫院標靶治療':{
        ...
        'definition': (
            '00:首次療程中未接受標靶治療。\n'
            '01:首次療程中接受標靶治療。\n'
            '82:因禁忌症或高風險或疾病進展未建議或未給予標靶治療。\n'
            '85:標靶治療規劃中治療，但治療前死亡或病危。\n'
            '86:規劃中治療未執行或轉他院，原因未明。\n'
            '87:規劃中治療但個案或家屬拒絕。\n'
            '88:規劃中治療但尚未執行。\n'
            '99:標靶治療是否建議或執行不詳。\n'
        ),
